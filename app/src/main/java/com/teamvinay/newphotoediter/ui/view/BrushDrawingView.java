...
/* renamed from: lisa.studio.photoeditor.ui.view.BrushDrawingView */
public class BrushDrawingView {//extends View {
    ...
    *//* access modifiers changed from: package-private *//*
    public void setOpacity(@IntRange(from = 0, mo93to = 255) int i) {
        this.mOpacity = i;
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (it.hasNext()) {
            ...
            if (point.vector2 != null) {
                this.tempRect.set(point.vector2.f641x, point.vector2.f643y, point.vector2.f642x1, point.vector2.f644y1);
    ...
    *//* renamed from: lisa.studio.photoeditor.ui.view.BrushDrawingView$LinePath *//*
    ...
    *//* renamed from: lisa.studio.photoeditor.ui.view.BrushDrawingView$Vector2 *//*
    ...
    *//* renamed from: lisa.studio.photoeditor.ui.view.BrushDrawingView$Point *//*
    class Point {
        LinePath linePath;
        Vector2 vector2;
