package com.teamvinay.newphotoediter.featuresfoto.puzzle.straight;
...
class StraightUtils {
    ...
    static Pair<ArrayList, ArrayList> cutArea(StraightArea straightArea, int i, int i2) {
        int i3;
        ArrayList arrayList = new ArrayList();
    ...
    static Pair<ArrayList, ArrayList> cutAreaSpiral(StraightArea straightArea) {
        ArrayList arrayList = new ArrayList();
