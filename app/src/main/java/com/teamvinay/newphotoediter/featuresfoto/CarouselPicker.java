...
public class CarouselPicker extends ViewPager {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = this.context.obtainStyledAttributes(attributeSet, C1084R.styleable.CarouselPicker, 0, 0);
    ...
    public static class CarouselViewAdapter extends PagerAdapter {
        ...
        public CarouselViewAdapter(Context context2, List<PickerItem> list, int i) {
            ...
            this.items = list;
            if (this.drawable == 0) {
                this.drawable = C1084R.C1089layout.carousel_picker;
            }
        }
        ...
        public Object instantiateItem(@NonNull ViewGroup viewGroup, int i) {
            ...
            ImageView imageView = (ImageView) inflate.findViewById(C1084R.C1087id.icon);
            View findViewById = inflate.findViewById(C1084R.C1087id.color);
