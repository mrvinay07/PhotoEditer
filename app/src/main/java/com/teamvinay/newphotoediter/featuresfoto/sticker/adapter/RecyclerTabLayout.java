...
public class RecyclerTabLayout extends RecyclerView {
    ...
    private void getAttributes(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1084R.styleable.rtl_RecyclerTabLayout, i, C1084R.style.rtl_RecyclerTabLayout);
        setIndicatorColor(obtainStyledAttributes.getColor(2, 0));
        setIndicatorHeight(obtainStyledAttributes.getDimensionPixelSize(3, 0));
        this.mTabTextAppearance = obtainStyledAttributes.getResourceId(13, C1084R.style.rtl_RecyclerTabLayout_Tab);
