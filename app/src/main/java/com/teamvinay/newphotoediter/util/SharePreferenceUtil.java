...
public class SharePreferenceUtil {
    ...
    public static String getConsentStatus(Context context) {
        return context.getSharedPreferences(PHOTO_EDITOR_PRO_2019, 0).getString("consent_status", ConsentStatus.UNKNOWN.name());
    }
    ...
    public static boolean isNonPersonalized(Context context) {
        return "NON_PERSONALIZED".equals(getConsentStatus(context));
    }
